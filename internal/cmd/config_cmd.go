...
type ConfigGetCmd struct {
	Key string `arg:"" help:"Config key to get (timezone, keyring_backend, default_account, proxy_base_url, proxy_api_key, aws_profile)"`
}
...
type ConfigSetCmd struct {
	Key   string `arg:"" help:"Config key to set (timezone, keyring_backend, default_account, proxy_base_url, proxy_api_key, aws_profile)"`
...
type ConfigUnsetCmd struct {
	Key string `arg:"" help:"Config key to unset (timezone, keyring_backend, default_account, proxy_base_url, proxy_api_key, aws_profile)"`
}
